...
import './intro.css';
import me from '../../images/saad1.png';
const Intro=()=>{
    return (
        <div className="i">
            <div className="i-left">
                <div className="i-left-wrapper">
                    ...
                    <h1 className="i-name">Meddah Saad</h1>
                    <div className="i-title">
                        <div className="i-title-wrapper">
                            <div className="i-title-item">Web Devloper With :</div>
                    ...
                    <p className="i-desc">
                        I design and devloper services for customers of all sizes,specializing
